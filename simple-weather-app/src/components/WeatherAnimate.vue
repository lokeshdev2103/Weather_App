<template>
    <div>
      <div
        ...
        :class="[
        {'weather-rain': this.$store.getters.getWeatherMain.info == 'Rain'},
        {'weather-snow': this.$store.getters.getWeatherMain.info == 'Snow'},
        {'weather-clear': this.$store.getters.getWeatherMain.info == 'Clear' || this.$store.getters.getWeatherMain.info == 'Mist'},
        {'weather-clouds': this.$store.getters.getWeatherMain.info == 'Clouds' || this.$store.getters.getWeatherMain.info == 'Haze'},
  ...
  &.weather-snow {
    ...
    &::after {
      ...
      background-image: url("../assets/images/snow2.png"),
        url("../assets/images/snow2.png"), url("../assets/images/snow4.png")
    }
  }
